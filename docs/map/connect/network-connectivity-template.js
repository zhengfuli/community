// URL: https://observablehq.com/@danwild/network-connectivity-template
// Title: [leaflet-network@0.5.2](https://bitbucket.csiro.au/projects/ONACI/repos/leaflet-network/browse) example
// Author: Dan Wild (@danwild)
// Version: 185
// Runtime version: 1

const m0 = {
  id: "baba32225487932b@185",
  variables: [
    {
      inputs: ["md"],
      value: (function(md){return(
md`# [leaflet-network@0.5.2](https://bitbucket.csiro.au/projects/ONACI/repos/leaflet-network/browse) example`
)})
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`Importing JS Libraries..`
)})
    },
    {
      name: "L",
...
window.d3 = d3
    ...
    },
    {
      name: "networkLayer",
      inputs: ["require","L"],
      value: (function(require,L){return(
require('leaflet-network@0.5.2').catch(() =>  L.networkLayer)
)})
    },
    {
      inputs: ["md"],
...
html`<link href='${resolve('leaflet@1.2.0/dist/leaflet.css')}' rel='stylesheet' />`
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`# Add / Edit Your Network Data Here:`
)})
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`Assign your own to the data to the variable in the expandable panel below:`
)})
    },
    {
      name: "data",
...
[{
    ...
    {
      name: "map",
      inputs: ["DOM","width","L","networkLayer","data"],
      value: (function*(DOM,width,L,networkLayer,data)
{
  ...
  // lastly, create and add the L.networkLayer, see options:
  // https://bitbucket.csiro.au/projects/ONACI/repos/leaflet-network
  let nLayer = networkLayer({
  ...
  // add to layer control as an overlay, and add to map
  layerControl.addOverlay(nLayer, 'Connectivity matrix');
  nLayer.addTo(map);
}
)
    }
